...
│
├── company_data.json  # Data for Elasticsearch indexing generated by scrapping the organisation webiste. Refer crio_scrapper. {scrapy crawl crio_spider -o ../company_data.json}
│
└── frontend/
